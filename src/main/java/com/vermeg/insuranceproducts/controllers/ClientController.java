...
import com.vermeg.insuranceproducts.ejb.ClientFacade;
...
public class ClientController implements Serializable {
    ...
    @EJB
    private com.vermeg.insuranceproducts.ejb.ClientFacade ejbFacade;
    ...
    public static class ClientControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Client) {
                ...
                return getStringKey(o.getNationalidentifier());
            } else {
